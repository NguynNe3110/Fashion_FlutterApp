...
abstract class $MyPagePageInitiatedCopyWith<$Res> {
  factory $MyPagePageInitiatedCopyWith(
    MyPagePageInitiated value,
    $Res Function(MyPagePageInitiated) then,
...
abstract class _$$MyPagePageInitiatedImplCopyWith<$Res>
    implements $MyPagePageInitiatedCopyWith<$Res> {
  factory _$$MyPagePageInitiatedImplCopyWith(
    _$MyPagePageInitiatedImpl value,
...
class __$$MyPagePageInitiatedImplCopyWithImpl<$Res>
  ...
  __$$MyPagePageInitiatedImplCopyWithImpl(
    _$MyPagePageInitiatedImpl _value,
...
class _$MyPagePageInitiatedImpl extends _MyPagePageInitiated {
  const _$MyPagePageInitiatedImpl({required this.id}) : super._();
...
abstract class _MyPagePageInitiated extends MyPagePageInitiated {
  const factory _MyPagePageInitiated({required final int id}) =
      _$MyPagePageInitiatedImpl;
  const _MyPagePageInitiated._() : super._();
...
abstract class $LogoutButtonPressedCopyWith<$Res> {
  factory $LogoutButtonPressedCopyWith(
    LogoutButtonPressed value,
    $Res Function(LogoutButtonPressed) then,
...
abstract class _$$LogoutButtonPressedImplCopyWith<$Res> {
  factory _$$LogoutButtonPressedImplCopyWith(
    _$LogoutButtonPressedImpl value,
...
class __$$LogoutButtonPressedImplCopyWithImpl<$Res>
  ...
  __$$LogoutButtonPressedImplCopyWithImpl(
    _$LogoutButtonPressedImpl _value,
...
class _$LogoutButtonPressedImpl extends _LogoutButtonPressed {
  const _$LogoutButtonPressedImpl() : super._();
...
abstract class _LogoutButtonPressed extends LogoutButtonPressed {
  const factory _LogoutButtonPressed() = _$LogoutButtonPressedImpl;
  const _LogoutButtonPressed._() : super._();
}
