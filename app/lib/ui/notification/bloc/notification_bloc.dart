    ...
    const mockData = [
      {
        ...
        'content': 'Đơn hàng #ORD12345 của bạn đã được hệ thống xác nhận và đang chờ đóng gói.',
        'time': '2 giờ trước'
      },
      {
      ...
      },
      {
        ...
        'content': 'Cảm ơn bạn đã gia nhập cộng đồng của chúng tôi. Chúc bạn có trải nghiệm mua sắm tuyệt vời!',
        'time': '1 ngày trước'
      },
    ];
