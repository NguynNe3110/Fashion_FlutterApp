    ...
    return runBlocCatching(
      action: () async {
        ...
        final results = await Future.wait([
          _getOrderByIdUseCase.execute(GetOrderByIdUseCaseInput(id: event.orderId)),
          _getOrderItemsUseCase.execute(GetOrderItemsUseCaseInput(orderId: event.orderId)),
        ]);
