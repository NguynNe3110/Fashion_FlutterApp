...
abstract class $SaveLanguageCodeInputCopyWith<$Res> {
  factory $SaveLanguageCodeInputCopyWith(
    SaveLanguageCodeInput value,
...
/// @nodoc
class _$SaveLanguageCodeInputCopyWithImpl<
  $Res,
...
class __$$SaveLanguageCodeUseCaseImplCopyWithImpl<$Res>
    extends
        _$SaveLanguageCodeInputCopyWithImpl<$Res, _$SaveLanguageCodeUseCaseImpl>
...
class _$SaveLanguageCodeUseCaseImpl extends _SaveLanguageCodeUseCase {
  const _$SaveLanguageCodeUseCaseImpl({required this.languageCode}) : super._();
...
abstract class _SaveLanguageCodeUseCase extends SaveLanguageCodeInput {
  const factory _SaveLanguageCodeUseCase({
    required final LanguageCode languageCode,
  }) = _$SaveLanguageCodeUseCaseImpl;
  const _SaveLanguageCodeUseCase._() : super._();
...
abstract class $SaveLanguageCodeOutputCopyWith<$Res> {
  factory $SaveLanguageCodeOutputCopyWith(
    SaveLanguageCodeOutput value,
    $Res Function(SaveLanguageCodeOutput) then,
  ) = _$SaveLanguageCodeOutputCopyWithImpl<$Res, SaveLanguageCodeOutput>;
}

/// @nodoc
class _$SaveLanguageCodeOutputCopyWithImpl<
  $Res,
...
class __$$SaveLanguageCodeOutputImplCopyWithImpl<$Res>
    extends
        _$SaveLanguageCodeOutputCopyWithImpl<$Res, _$SaveLanguageCodeOutputImpl>
