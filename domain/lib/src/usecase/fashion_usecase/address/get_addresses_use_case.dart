...
class GetAddressesUseCase
    extends
        BaseFutureUseCase<GetAddressesUseCaseInput, GetAddressesUseCaseOutput> {
  ...
  @protected
  @override
  Future<GetAddressesUseCaseOutput> buildUseCase(
    GetAddressesUseCaseInput input,
  ) async {
...
@freezed
sealed class GetAddressesUseCaseInput extends BaseInput
    with _$GetAddressesUseCaseInput {
  const GetAddressesUseCaseInput._();
  const factory GetAddressesUseCaseInput({required String userId}) =
      _GetAddressesUseCaseInput;
}

@freezed
sealed class GetAddressesUseCaseOutput extends BaseOutput
    with _$GetAddressesUseCaseOutput {
