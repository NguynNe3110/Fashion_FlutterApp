...
class DeleteCartItemUseCase
  ...
  @protected
  @override
  Future<DeleteCartItemUseCaseOutput> buildUseCase(
    DeleteCartItemUseCaseInput input,
  ) async {
...
@freezed
sealed class DeleteCartItemUseCaseInput extends BaseInput
    with _$DeleteCartItemUseCaseInput {
  const DeleteCartItemUseCaseInput._();
  const factory DeleteCartItemUseCaseInput({required String cartItemId}) =
      _DeleteCartItemUseCaseInput;
}

@freezed
sealed class DeleteCartItemUseCaseOutput extends BaseOutput
    with _$DeleteCartItemUseCaseOutput {
