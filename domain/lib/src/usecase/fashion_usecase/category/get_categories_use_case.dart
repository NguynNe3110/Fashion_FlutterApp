...
class GetCategoriesUseCase
  ...
  @protected
  @override
  Future<GetCategoriesUseCaseOutput> buildUseCase(
    GetCategoriesUseCaseInput input,
  ) async {
...
@freezed
sealed class GetCategoriesUseCaseInput extends BaseInput
    with _$GetCategoriesUseCaseInput {
  const GetCategoriesUseCaseInput._();
  const factory GetCategoriesUseCaseInput() = _GetCategoriesUseCaseInput;
}

@freezed
sealed class GetCategoriesUseCaseOutput extends BaseOutput
    with _$GetCategoriesUseCaseOutput {
