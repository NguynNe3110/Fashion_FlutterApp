...
class GetCategoryByIdUseCase
    extends
        BaseFutureUseCase<
          GetCategoryByIdUseCaseInput,
          GetCategoryByIdUseCaseOutput
        > {
  ...
  @protected
  @override
  Future<GetCategoryByIdUseCaseOutput> buildUseCase(
    GetCategoryByIdUseCaseInput input,
  ) async {
...
@freezed
sealed class GetCategoryByIdUseCaseInput extends BaseInput
    with _$GetCategoryByIdUseCaseInput {
  const GetCategoryByIdUseCaseInput._();
  const factory GetCategoryByIdUseCaseInput({required String id}) =
      _GetCategoryByIdUseCaseInput;
}

@freezed
sealed class GetCategoryByIdUseCaseOutput extends BaseOutput
    with _$GetCategoryByIdUseCaseOutput {
