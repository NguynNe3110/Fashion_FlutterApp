...
class GetFavoritesUseCase
    extends
        BaseFutureUseCase<GetFavoritesUseCaseInput, GetFavoritesUseCaseOutput> {
  ...
  @protected
  @override
  Future<GetFavoritesUseCaseOutput> buildUseCase(
    GetFavoritesUseCaseInput input,
  ) async {
...
@freezed
sealed class GetFavoritesUseCaseInput extends BaseInput
    with _$GetFavoritesUseCaseInput {
  const GetFavoritesUseCaseInput._();
  const factory GetFavoritesUseCaseInput({required String userId}) =
      _GetFavoritesUseCaseInput;
}

@freezed
sealed class GetFavoritesUseCaseOutput extends BaseOutput
    with _$GetFavoritesUseCaseOutput {
