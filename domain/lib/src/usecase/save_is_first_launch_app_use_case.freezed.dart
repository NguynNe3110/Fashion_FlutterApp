...
mixin _$SaveIsFirstLaunchAppInput {
  ...
  /// Create a copy of SaveIsFirstLaunchAppInput
...
abstract class $SaveIsFirstLaunchAppInputCopyWith<$Res> {
  factory $SaveIsFirstLaunchAppInputCopyWith(
    SaveIsFirstLaunchAppInput value,
...
/// @nodoc
class _$SaveIsFirstLaunchAppInputCopyWithImpl<
  $Res,
...
>
  ...
  @override
  $Res call({Object? isFirstLaunchApp = null}) {
    return _then(
      _value.copyWith(
...
class __$$SaveIsFirstLaunchAppInputImplCopyWithImpl<$Res>
    extends
        _$SaveIsFirstLaunchAppInputCopyWithImpl<
          $Res,
...
class _$SaveIsFirstLaunchAppInputImpl extends _SaveIsFirstLaunchAppInput {
...
abstract class _SaveIsFirstLaunchAppInput extends SaveIsFirstLaunchAppInput {
  const factory _SaveIsFirstLaunchAppInput({
    required final bool isFirstLaunchApp,
  }) = _$SaveIsFirstLaunchAppInputImpl;
  const _SaveIsFirstLaunchAppInput._() : super._();
...
abstract class $SaveIsFirstLaunchAppOutputCopyWith<$Res> {
  factory $SaveIsFirstLaunchAppOutputCopyWith(
    SaveIsFirstLaunchAppOutput value,
    $Res Function(SaveIsFirstLaunchAppOutput) then,
  ) =
      _$SaveIsFirstLaunchAppOutputCopyWithImpl<
        $Res,
...
/// @nodoc
class _$SaveIsFirstLaunchAppOutputCopyWithImpl<
  $Res,
...
>
  ...
  /// Create a copy of SaveIsFirstLaunchAppOutput
  /// with the given fields replaced by the non-null parameter values.
}
