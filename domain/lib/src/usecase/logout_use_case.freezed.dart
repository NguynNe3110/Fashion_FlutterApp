...
abstract class _$$LogoutUseCaseImplCopyWith<$Res> {
  factory _$$LogoutUseCaseImplCopyWith(
    _$LogoutUseCaseImpl value,
    $Res Function(_$LogoutUseCaseImpl) then,
...
class __$$LogoutUseCaseImplCopyWithImpl<$Res>
  ...
  __$$LogoutUseCaseImplCopyWithImpl(
    _$LogoutUseCaseImpl _value,
    $Res Function(_$LogoutUseCaseImpl) _then,
  ) : super(_value, _then);
...
class _$LogoutUseCaseImpl extends _LogoutUseCase {
  const _$LogoutUseCaseImpl() : super._();
...
abstract class _LogoutUseCase extends LogoutInput {
  const factory _LogoutUseCase() = _$LogoutUseCaseImpl;
  const _LogoutUseCase._() : super._();
}
